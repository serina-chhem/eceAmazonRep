...
if($db_found)
{
	if(isset($_GET['show']))
	{
		...
		<div class="texte-2" style="text-align: center;">
			...
			<a href="musiqueAcheteur.php"><h4>Retour</h4></a>
		</div><br>
		<?php
	}
	else
	{
		?><div class="texte-2"><h1>Bienvenue dans la catégorie Musique</h1></div><?php
		$sql = "SELECT * from products WHERE category='Musique'";
		$result = mysqli_query($db_handle, $sql);
